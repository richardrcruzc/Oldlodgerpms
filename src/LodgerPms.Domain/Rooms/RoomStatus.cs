...
{
    public class RoomStatus : AgregateRoot.RoomStatusState
    {
        public static RoomStatus Create(RoomInfo room, Booking boking , Status status, DateTime statusFrom, DateTime statusTo,
        ...
        public void Update(RoomInfo room, Booking boking, Status status, DateTime statusFrom, DateTime statusTo,
            string description, DateTime assignedDate, string assignedby, string reasonCode)
        {
            BookingId = boking.Id;
            Booking = boking;
