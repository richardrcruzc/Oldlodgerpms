...
namespace LodgerPms.Domain.Departments.Models
{
    ...
    {
        public static Department Create(DepartmentGroup departmentGroup, DepartmentType departmentType, string description, bool applyTax, decimal amount, decimal percentage)
        {
